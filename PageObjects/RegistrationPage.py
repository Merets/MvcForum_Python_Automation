...
class RegistrationPage(object):
    ...
    def fill_input_text(self, element_id, text_value):
        ...
        input_element = self.browser.wait_for_element(By.ID, element_id, 10, description)
        input_element.this_element.send_keys(text_value)
        print(f'Value "{text_value}" inserted into "{element_id}" input field')

    def register_submit(self):
        register_button = self.browser.wait_for_element(By.CSS_SELECTOR, "button[type='submit']", 10,
